...
namespace DayLight.Subclasses.Subclasses.SCPs.SCP096;

[Serializable]
[CustomRole(RoleTypeId.Scp096)]
public class ShyguyBrick : Subclass
{
    ...
    public override RoleTypeId Role { get; set; } = RoleTypeId.Scp096;
    public override string Name { get; set; } = "096 Brick";
